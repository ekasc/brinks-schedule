-- Schedule — D1 schema (also used for local better-sqlite3)
-- Run: npx wrangler d1 execute DB --file=./d1-schema.sql
-- Or locally: sqlite3 data/schedule.db < d1-schema.sql
...
CREATE TABLE IF NOT EXISTS jobs (
  ...
  svc_internet_detail TEXT,
  svc_home_phone INTEGER NOT NULL DEFAULT 0,
  svc_home_phone_detail TEXT,
